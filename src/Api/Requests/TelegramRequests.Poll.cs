...
{
    public async Task<RequestResponse<Message>> SendPoll(
        long chatId, 
        string question, 
        ...
        CancellationToken ct = default)
    {
        ...
        return await SendRequest<Message>(TelegramMethods.SEND_POLL, parameters, ct:ct);
    }
    
    public async Task<RequestResponse<Message>> StopPoll(
        long chatId, 
        long messageId,
        IKeyboardMarkup? keyboard = null,
        ...
        CancellationToken ct = default)
    {
        ...
        return await SendRequest<Message>(TelegramMethods.STOP_POLL, parameters, ct:ct);
    }
}